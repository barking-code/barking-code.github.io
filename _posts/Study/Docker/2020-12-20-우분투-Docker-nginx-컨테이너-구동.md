---
layout: post
title: "[Ubuntu]Docker이미지를 받아 컨테이너 구동하기"
categories:
  - Study
  - Docker
tags:
...
![image-20201220210649862](../../assets/img/image-20201220210649862.png)
...
1. nginx 이미지 pull 받기
   ...
   * pull 명령어를 통해 도커 허브에서 이미지를 받을 수 있다
     ...
     ![image-20201220192402140](../../assets/img/image-20201220192402140.png)
...
2. 컨테이너 생성하기
   ...
   * 옵션 설명
     ...
     * --name: 생성할 컨테이너의 이름을 정한다. 옵션을 사용하지 않을 경우 랜덤으로 생성된다.
     ...
     ![image-20201220195547270](../../assets/img/image-20201220195547270.png)

   * 잘 동작하는지 확인해보기

     ![image-20201220195945703](../../assets/img/image-20201220195945703.png)
     ...
     * 443의 경우 개방은 되어있지만 nginx에서 443 포트로 들어오는 요청에 대해 응답을 하고 있지 않기 때문에 설정을 통해 443포트로 들어오는 요청에도 응답하도록 셋팅해야한다. 아래는 리다이렉트로 응답하는지 확인만 할 수 있도록 설정해놓았다.
     ...
     ![image-20201220203648539](../../assets/img/image-20201220203648539.png)
